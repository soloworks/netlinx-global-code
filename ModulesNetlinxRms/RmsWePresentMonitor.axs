MODULE_NAME='RmsWePresentMonitor'(DEV vdvRMS,
											DEV vdvDevice)
...
CHAR MONITOR_ASSET_NAME[50]             = 'WePresent';


// RMS Asset Properties (Optional)
CHAR MONITOR_ASSET_DESCRIPTION[50]      = '';
CHAR MONITOR_ASSET_MANUFACTURERNAME[50] = 'WePresent';
CHAR MONITOR_ASSET_MODELNAME[50]        = 'WePesent Device';
...
CHAR MONITOR_NAME[]       = 'Solo Control WePresent Monitor';
CHAR MONITOR_DEBUG_NAME[] = 'SC_RMS_WePresent_Monitor';
CHAR MONITOR_VERSION[]    = '4.2.35';
(***********************************************************)
