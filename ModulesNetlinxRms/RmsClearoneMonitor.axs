MODULE_NAME='RmsClearoneMonitor'(DEV vdvRMS,
                                           DEV vdvDevice)

/******************************************************************************
	RMS Monitoring of BiAmp Tesira by Solo Control
******************************************************************************/
...
CHAR MONITOR_ASSET_NAME[50]             = 'DSP';

// RMS Asset Properties (Optional)
CHAR MONITOR_ASSET_DESCRIPTION[50]      = '';
CHAR MONITOR_ASSET_MANUFACTURERNAME[50] = 'ClearOne';
CHAR MONITOR_ASSET_MODELNAME[50]        = 'Converge';
				...
				SWITCH(REMOVE_STRING(DATA.TEXT,',',1)){
					CASE 'META,':{
						SWITCH(REMOVE_STRING(DATA.TEXT,',',1)){
							...
							CASE 'FIRMWARE,': { 	 MONITOR_ASSET_FIRMWAREVERSION 	= DATA.TEXT }
