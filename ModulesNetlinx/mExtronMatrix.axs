...
INTEGER MODEL_XTPIICP3200    	= 11
INTEGER MODEL_DXP42HD4KPlus   = 12
INTEGER MODEL_DXP44HD4KPlus   = 13
INTEGER MODEL_DXP84HD4KPlus   = 14
INTEGER MODEL_DXP88HD4KPlus   = 15
INTEGER MODEL_DXP168HD4KPlus  = 16
INTEGER MODEL_DXP1616HD4KPlus = 17
...
DEFINE_FUNCTION fnPoll(){
	...
	ELSE{
		SWITCH(myMatrix.MODEL_ID){
			CASE MODEL_XTPIICP3200: {/* Do Nothing Here */}
		...
		IF(!myMatrix.DISABLED){
			...
			SELECT{
				...
				ACTIVE(myMatrix.LAST_SENT == '0LS'):{
					STACK_VAR INTEGER x
					STACK_VAR CHAR States[38]
					States = fnStripCharsRight(DATA.TEXT,2)
					IF(FIND_STRING(States,'Frq0',1)){
						REMOVE_STRING(States,'Frq0',1)
						fnRemoveWhiteSpace(States)
					}
				...
				ACTIVE(myMatrix.LAST_SENT == 'N'):{
					...
					SWITCH(myMatrix.META_PART_NUMBER){
						CASE '60-1678-01':myMatrix.MODEL_ID = MODEL_DXP42HD4KPlus
						CASE '60-1493-01':myMatrix.MODEL_ID = MODEL_DXP44HD4K
						CASE '60-1493-21':myMatrix.MODEL_ID = MODEL_DXP44HD4KPlus
						CASE '60-1494-01':myMatrix.MODEL_ID = MODEL_DXP84HD4k
						CASE '60-1494-21':myMatrix.MODEL_ID = MODEL_DXP84HD4kPlus
						CASE '60-1495-01':myMatrix.MODEL_ID = MODEL_DXP88HD4k
						CASE '60-1495-21':myMatrix.MODEL_ID = MODEL_DXP88HD4kPlus
						CASE '60-1496-01':myMatrix.MODEL_ID = MODEL_DXP168HD4K
						CASE '60-1496-21':myMatrix.MODEL_ID = MODEL_DXP168HD4KPlus
						CASE '60-1497-01':myMatrix.MODEL_ID = MODEL_DXP1616HD4K
						CASE '60-1497-21':myMatrix.MODEL_ID = MODEL_DXP1616HD4KPlus
						...
						CASE '60-1546-01':myMatrix.MODEL_ID = MODEL_XTPIICP3200
					}
					SWITCH(myMatrix.MODEL_ID){
						CASE MODEL_DXP42HD4KPlus:		myMatrix.META_MODEL = 'DXP42HD4KPlus'
						CASE MODEL_DXP44HD4K:			myMatrix.META_MODEL = 'DXP44HD4K'
						CASE MODEL_DXP44HD4KPlus:		myMatrix.META_MODEL = 'DXP44HD4KPlus'
						CASE MODEL_DXP84HD4k:			myMatrix.META_MODEL = 'DXP84HD4K'
						CASE MODEL_DXP84HD4KPlus:		myMatrix.META_MODEL = 'DXP84HD4KPlus'
						CASE MODEL_DXP88HD4k:			myMatrix.META_MODEL = 'DXP88HD4K'
						CASE MODEL_DXP88HD4KPlus:		myMatrix.META_MODEL = 'DXP88HD4KPlus'
						CASE MODEL_DXP168HD4K:			myMatrix.META_MODEL = 'DXP168HD4K'
						CASE MODEL_DXP168HD4KPlus:		myMatrix.META_MODEL = 'DXP168HD4KPlus'
						CASE MODEL_DXP1616HD4K:			myMatrix.META_MODEL = 'DXP1616HD4K'
						CASE MODEL_DXP1616HD4KPlus:	myMatrix.META_MODEL = 'DXP1616HD4KPlus'
						...
						CASE MODEL_XTPIICP3200:			myMatrix.META_MODEL = 'XTPIICP3200'
						DEFAULT:								myMatrix.META_MODEL = 'NOT IMPLEMENTED'
					}
					SWITCH(myMatrix.MODEL_ID){
						CASE MODEL_DXP42HD4KPlus:
						CASE MODEL_DXP44HD4K:
						CASE MODEL_DXP44HD4KPlus:
						CASE MODEL_DXP84HD4k:
						CASE MODEL_DXP84HD4KPlus:
						CASE MODEL_DXP88HD4k:
						CASE MODEL_DXP88HD4KPlus:
						CASE MODEL_DXP168HD4K:
						CASE MODEL_DXP168HD4KPlus:
						CASE MODEL_DXP1616HD4K:
						CASE MODEL_DXP1616HD4KPlus:
						CASE MODEL_DTPCP824K:
						CASE MODEL_DTPCP844K:
						CASE MODEL_DTPCP864K:
						CASE MODEL_DTPCP1084K:
						CASE MODEL_XTPIICP3200:	myMatrix.HAS_NETWORK = TRUE
					...
					SWITCH(myMatrix.MODEL_ID){
						...
						CASE MODEL_DTPCP864K:
						CASE MODEL_DTPCP1084K:
						CASE MODEL_XTPIICP3200:	myMatrix.HAS_AUDIO = TRUE
				...
				ACTIVE(myMatrix.LAST_SENT == 'I'):{
					IF(FIND_STRING(DATA.TEXT,'DTPCP',1)){
						...
						SWITCH(fnStripCharsRight(DATA.TEXT,2)){
							...
							DEFAULT:{
								fnDebug(TRUE,'Extron DTPCP','Model Not Recognised')
							}
						}
					}
					ELSE{
						IF(FIND_STRING(DATA.TEXT,'Info00*',1)){
							REMOVE_STRING(DATA.TEXT,'Info00*',1)
						}
						IF(FIND_STRING(DATA.TEXT,'Info00',1)){
							REMOVE_STRING(DATA.TEXT,'Info00',1)
							fnRemoveWhiteSpace(DATA.TEXT)
						}
