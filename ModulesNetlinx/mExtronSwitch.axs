...
INTEGER MODEL_SW2HD4k 		= 09
INTEGER MODEL_SW2HD4kPlus	= 10
INTEGER MODEL_SW4HD4K 		= 11
INTEGER MODEL_SW4HD4KPlus	= 12
INTEGER MODEL_SW4HD4kDTP   = 13
INTEGER MODEL_SW6HD4k 		= 14
INTEGER MODEL_SW6HD4kPlus	= 15
INTEGER MODEL_SW8HD4K 		= 16
INTEGER MODEL_SW8HD4KPlus	= 17
INTEGER MODEL_SW6 			= 18
INTEGER MODEL_SW8 			= 19
INTEGER MODEL_MLAVC10 		= 20
INTEGER MODEL_IN1804 		= 21
INTEGER MODEL_IN1804DI		= 22
INTEGER MODEL_IN1804DO		= 23
INTEGER MODEL_IN1806 		= 24
INTEGER MODEL_IN1808 		= 25
				...
				ACTIVE(mySwitch.LAST_SENT == 'N'):{
					...
					ELSE IF(mySwitch.MODEL_ID == MODEL_NA){
						SWITCH(mySwitch.META_PART_NUMBER){
							...
							CASE '60-1625-01':mySwitch.MODEL_ID = MODEL_SW4HD4kDTP	// DTP T SW4 HD 4K
							CASE '60-841-03': mySwitch.MODEL_ID = MODEL_SW6				// SW6
							CASE '60-1485-01':mySwitch.MODEL_ID = MODEL_SW6HD4k		// SW6 HD 4k
							CASE '60-1605-01':mySwitch.MODEL_ID = MODEL_SW6HD4kPlus	// SW6 HD 4k Plus
							CASE '60-841-04': mySwitch.MODEL_ID = MODEL_SW8				// SW8
							CASE '60-1486-01':mySwitch.MODEL_ID = MODEL_SW8HD4k		// SW8 HD 4K
							CASE '60-1606-01':mySwitch.MODEL_ID = MODEL_SW8HD4KPlus	// SW8 HD 4K Plus
