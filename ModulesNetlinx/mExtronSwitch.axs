			...
			SWITCH(fnStripCharsRight(REMOVE_STRING(DATA.TEXT,'-',1),1)){
				...
				CASE 'MUTE':{
					...
					SWITCH(mySwitch.MODEL_ID){
						...
						CASE MODEL_IN1804:
						CASE MODEL_IN1804DI:
						CASE MODEL_IN1804DO: fnAddToQueue("ITOA(mySwitch.MUTE),'Z'",FALSE)
						CASE MODEL_IN1806:
						CASE MODEL_IN1808:	fnAddToQueue("$1B,'D4*',ITOA(mySwitch.MUTE),'GRPM',$0D",FALSE)
						CASE MODEL_IN1606:
						CASE MODEL_IN1608:
...
DEFINE_EVENT TIMELINE_EVENT[TLID_GAIN]{
	IF(mySwitch.GAIN_PEND){
		SWITCH(mySwitch.MODEL_ID){
			...
			CASE MODEL_IN1804DO:
			CASE MODEL_IN1806:
			CASE MODEL_IN1808:   fnAddToQueue("ITOA(mySwitch.LAST_GAIN),'V'",FALSE)
			CASE MODEL_IN1606:
			CASE MODEL_IN1608:
